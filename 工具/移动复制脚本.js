...
function moveCode(name) {
    from = '/storage/emulated/0/Pictures/Screenshots/' + name + '/'
    to = '/storage/emulated/0/脚本/' + name + '/'
    copy(from, to)
}
function moveImg() {
    from = '/storage/emulated/0/Pictures/Screenshots/img/'
    to = '/storage/emulated/0/脚本/' + name + '/img/'
    copy(from, to)
