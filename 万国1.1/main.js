...
脚本路径 = '/storage/emulated/0/Pictures/Screenshots/js/'
header = 'file:///sdcard/脚本/玩过觉醒/img/appHeader.png'


header = 'file://' + files.path('img/appHeader.png')
...
deploy = init()
function init() {
    obj = { device: 'phone', leval: 10, showlog: false }
                    ...
                    <frame>
                        <scroll>
                            <vertical gravity="center_horizontal">
                                ...
                                <Switch id="consoleShow" text="控制台显隐" checked="null" textColor="blue" padding="8 8 8 8" textSize="15sp" />
...
ui.start.on('click', () => {
    ...
    threads.start(function () {
        ...
        engines.execScriptFile(脚本路径 + 'wanguo.js')
    })
})
